...
from pyecharts import Bar, Kline, Map, Pie, WordCloud, Line
...
def create_simple_bar():
    attr = ["{}일".format(i) for i in range(30)]
    v1 = [random.randint(1, 30) for _ in range(30)]
    bar = Bar("Bar - datazoom - slider Sample")
...
def create_simple_kline():
    ...
    # v2 = [[2320.26, 2320.26, 2287.3, 2362.94],
    #       [2300, 2291.3, 2288.26, 2308.38],
    #       [2295.35, 2346.5, 2295.35, 2345.92],
    #       [2347.22, 2358.98, 2337.35, 2363.8],
    #       [2360.75, 2382.48, 2347.89, 2383.76],
    ...
    #       [2282.17, 2263.97, 2253.25, 2286.33],
    #       [2255.77, 2270.28, 2253.31, 2276.22]]
    kline = Kline("Stock Chart")
    kline.add("Samsung Electronics", ["2017/7/{}".format(i + 1) for i in range(31)], v1, mark_point=["max"], is_datazoom_show=True)
    # kline.add("News", ["2017/7/{}".format(i + 1) for i in range(31)], v2)
    kline.renderer = 'svg'
    # kline = Kline("K 线图示例")
